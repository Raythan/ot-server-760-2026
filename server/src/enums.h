...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_HITCHANCE = 1 << 13,
	ITEM_ATTRIBUTE_SHOOTRANGE = 1 << 14,
	ITEM_ATTRIBUTE_OWNER = 1 << 15,
	ITEM_ATTRIBUTE_DURATION = 1 << 16,
	ITEM_ATTRIBUTE_DECAYSTATE = 1 << 17,
	ITEM_ATTRIBUTE_CORPSEOWNER = 1 << 18,
	ITEM_ATTRIBUTE_CHARGES = 1 << 19,
	ITEM_ATTRIBUTE_FLUIDTYPE = 1 << 20,
	ITEM_ATTRIBUTE_DOORID = 1 << 21,
	ITEM_ATTRIBUTE_KEYNUMBER = 1 << 22,
	ITEM_ATTRIBUTE_KEYHOLENUMBER = 1 << 23,
	ITEM_ATTRIBUTE_DOORQUESTNUMBER = 1 << 24,
	ITEM_ATTRIBUTE_DOORQUESTVALUE = 1 << 25,
