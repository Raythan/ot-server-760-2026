...
bool ConfigManager::load()
{
	...
	boolean[QUERY_PLAYER_CONTAINERS] = getGlobalBoolean(L, "queryPlayerContainers", true);
	...
	integer[BAN_LENGTH] = getGlobalNumber(L, "banLength", 15 * 24 * 60 * 60);
	...
	integer[RED_SKULL_TIME] = getGlobalNumber(L, "redSkullTime", 15 * 24 * 60 * 60);
