...
local config = {
	first_room_pos = {x = 32065, y = 32558, z = 7}, -- posicao da primeira pos (linha 1 coluna 1) {x = 32065, y = 32558, z = 7}
	distX= 20, -- distancia em X entre cada sala (de uma mesma linha)
	distY= 18, -- distancia em Y entre cada sala (de uma mesma coluna)
	rX= 23, -- numero de colunas
	rY= 12 -- numero de linhas
}
