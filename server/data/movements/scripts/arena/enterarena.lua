function onStepIn(creature, item, position, fromPosition)
	...
	elseif storageId == 1 then
		local arenaPos = {
							[7300] = {pos=Position(31922,31435,7),centerPos = Position(31963,31435,7),monster='Medusa'},
							[7200] = {pos=Position(31922,31451,7),centerPos = Position(31963,31451,7),monster='Drasilla'},
							[7100] = {pos=Position(31922,31466,7),centerPos = Position(31963,31466,7),monster='Achad'},
						}
