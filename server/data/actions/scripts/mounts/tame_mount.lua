local tameConfig = {
    [5217] = {
        tameMonster = "Black Sheep", --Needs to be all lowercase
        mountId = 4,
        chances = {
            [1] = {name = "sucess", chance = 20, sendText = "You have successfully tamed a black sheep!!"}, --20%
            [2] = {name = "runAway", chance = 10, sendText = "The black sheep ran away.."}, --10%
            [3] = {name = "itemBreak", chance = 10, sendText = "You broke the reins.."}, --10%
            [4] = {name = "growl", sendText = "Maeh...."} --This will trigger if non of the above gets triggered, doesnt need chance value.
        }
    }
}
